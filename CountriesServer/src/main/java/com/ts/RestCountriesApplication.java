...
public class RestCountriesApplication {
	...
	public static void main(String[] args) {
		...
		final String uri = "http://localhost:9000/api/countryCode/";
	    final String uri2 = "http://localhost:9000/api/countryName/";
	    ...
	    while (!exit) {
	        ...
	        case 1 :
	        	...
	        	String result = restTemplate.getForObject(uri+input.nextLine(), String.class);
	        ...
	        case 2 :
	        	...
	        	input = new Scanner(System.in);
	        	String result1 = restTemplate.getForObject(uri2+input.nextLine(), String.class);
